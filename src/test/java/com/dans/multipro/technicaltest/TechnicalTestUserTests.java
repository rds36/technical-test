...
@SpringBootTest(classes = TechnicalTestApplicationTestConfiguration.class)
class TechnicalTestUserTests {

    @Autowired
    PositionService positionService;

    private final UUID POSITION_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51fd148cfb41");
    ...
    public void init(){
        position = Position.builder()
                ...
                .type("Full Time")
                .companyLogo("https://jobs.github.com/rails/active_storage/blobs/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBBaUtqIiwiZXhwIjpudWxsLCJwdXIiOiJibG9iX2lkIn19--82886ff47e94ff4c0255b95773a9667644768b2b/SR%20Logo.png")
                .company("SweetRush")
                ...
                .howToApply("<p>If this describes your interests and experience, please submit your current resume and salary requirements through the following link:\n<a href=\"https://www.sweetrush.com/join-us/\">https://www.sweetrush.com/join-us/</a></p>\n")
                .build();

            Mockito.when(positionService.getPositionById(POSITION_ID)).thenReturn(position);
//            Mockito.when(positionService.getAllPosition()).thenReturn(position);
    }

    @Test
    public void testGetPositionById(){
        Position positionResult = positionService.getPositionById(POSITION_ID);
        Assertions.assertEquals(POSITION_ID, positionResult.getId());
    }
}
